...
public class Tower extends SpriteBase {
    ...
    public void checkTarget()
    {
        ...
        double distanceX = Target.getImageView().getTranslateX() - getCenterX();
        double distanceY = Target.getImageView().getTranslateY() - getCenterY();
    ...
    {
        Bullet bullet = new Bullet(this.EntitiesGroup, this.damage, 0, 0);
